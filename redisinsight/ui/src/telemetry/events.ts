...
export enum TelemetryEvent {
  ...
  VECTOR_SEARCH_INITIAL_MESSAGE_DISPLAYED = 'VECTOR_SEARCH_INITIAL_MESSAGE_DISPLAYED',
  VECTOR_SEARCH_ONBOARDING_TRIGGERED = 'VECTOR_SEARCH_ONBOARDING_TRIGGERED',
  VECTOR_SEARCH_ONBOARDING_PROCEED_TO_INDEX_INFO = 'VECTOR_SEARCH_ONBOARDING_PROCEED_TO_INDEX_INFO',
  ...
  SEARCH_SAVED_QUERIES_PANEL_CLOSED = 'SEARCH_SAVED_QUERIES_PANEL_CLOSED',
  SEARCH_SAVED_QUERIES_INSERT_CLICKED = 'SEARCH_SAVED_QUERIES_INSERT_CLICKED',
  SEARCH_SAVED_QUERIES_INDEX_CHANGED = 'SEARCH_SAVED_QUERIES_INDEX_CHANGED',
  SEARCH_COMMAND_SUBMITTED = 'SEARCH_COMMAND_SUBMITTED',
  // SEARCH_RESULT_VIEW_CHANGED = 'SEARCH_RESULT_VIEW_CHANGED', Note: Currently, we don't have this action in the UI, so we can't track it.
  ...
  SEARCH_MANAGE_INDEX_DETAILS_CLOSED = 'SEARCH_MANAGE_INDEX_DETAILS_CLOSED',
  SEARCH_MANAGE_INDEX_DELETED = 'SEARCH_MANAGE_INDEX_DELETED',
}
